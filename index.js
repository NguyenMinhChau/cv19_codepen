...
`;
    ...
    <nav class="navbar navbar-expand navbar-light text-center bg-white topbar mb-4 static-top shadow">
      <div class="col-md-12">
                    ...
                    <h5 class="font-weight-bold text-uppercase mb-1" style="display: contents;">
                    COVID-19 Live Tracker
                    <h6 id="clockDiv" style="color: green; font-weight: bold">
                        ...
                        if(10>mi){mi="0"+mi}
                        if(10>se){se="0"+se}
                        document.getElementById("clockDiv").innerHTML=d+"/"+m+"/"+y+" - "+h+":"+mi+":"+se+" (Vietnam time)"; }
                    </h6>
                    </h5>
      </div>
    </nav>
  ...
  <div class="col-xl-3 col-md-3 mb-4">
    ...
    <footer class="sticky-footer bg-light shadow">
                ...
                <h6 class="text-info font-weight-bold"><u>Follow Me</u></h6>
                <div class="social-btns"><a class="btn facebook" href="https://www.facebook.com/profile.php?id=1000040064117766"><i class="fa fa-facebook"></i></a><a class="btn twitter" href="#"><i class="fa fa-twitter"></i></a><a class="btn instagram" href="https://instagram.com/nguyenminhchau_3110?r=nametag"><i class="fa fa-instagram"></i></a><a class="btn skype" href="#"><i class="fa fa-skype"></i></a><a class="btn youtube" href="https://youtube.com/channel/UCoL7Uc3TAaBOvdx08DFcsUw"><i class="fa fa-youtube"></i></a>
</div><hr>
                    <div class="copyright text-center my-auto">
                        <span class="font-weight-bold">Copyright &copy; COVID-19 Live Tracker <?php echo date('Y') ?></span>
                    </div>
                </div>
            </footer>
  `);
